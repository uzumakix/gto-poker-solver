...
class CFRSolver:
    ...
    def train(self, iterations):
        ...
        Also populates self.strategy_history with per-info-set
        bet probabilities at each checkpoint for convergence plots.
        """
        history_log = []
        self.strategy_history = {}  # key -> list of (iter, bet_prob)
